import sys
sys.path.append('/home/liuchuanloong/amy/deep_retrieval/deep-retrieval-master/py-faster-rcnn/caffe-fast-rcnn/python')
...
class Dataset:
    ...
    def load(self):
        # Load the dataset GT
        self.lab_root = '{0}/lab1/'.format(self.path)
